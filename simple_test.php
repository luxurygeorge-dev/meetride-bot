...
if (strpos($content, '-1002544521661') !== false) {
    echo "✅ БОЕВАЯ группа (-1002544521661) найдена\n";
} else {
    echo "❌ БОЕВАЯ группа не найдена\n";
}

// Проверка 2: Тестовая группа НЕ должна быть
if (strpos($content, '-1001649190984') !== false) {
    echo "❌ ОШИБКА! Тестовая группа (-1001649190984) найдена в коде!\n";
} else {
    echo "✅ Тестовая группа НЕ найдена (это нормально для боевой версии)\n";
}
