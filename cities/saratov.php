<?php
/**
 * Конфигурация для города: Саратов
...
return [
    ...
    'bitrix24' => [
        ...
        'user_id' => 9,
        'category_id' => 3, // Саратов
        'funnel_prefix' => 'C3', // Без префикса (используется category_id)
    ],
    ...
    'stages' => [
        'new' => 'C3:NEW',
        'preparation' => 'C3:PREPARATION',
        'prepayment_invoice' => 'C3:PREPAYMENT_INVOICE',
        'executing' => 'C3:EXECUTING',
        'final_invoice' => 'C3:FINAL_INVOICE',
        'won' => 'C3:WON',
        'lose' => 'C3:LOSE',
    ],
